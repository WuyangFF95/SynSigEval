...
This version (0.3.2) and previous version (0.3.1) are suitable for assessing the extraction accuracy in paper
...
Check NEWS.md for differences between version 0.3.2 and previous versions. 
...
https://github.com/WuyangFF95/SynSigEval/blob/main/data-raw/SynSigEval_0.3.2.pdf
